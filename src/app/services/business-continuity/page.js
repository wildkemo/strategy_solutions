  ...
  useEffect(() => {
    const fetchService = async () => {
      try {
        ...
        const businessContinuityService = services.find(
          (s) => s.title.toLowerCase() === "business continuity"
        );

        if (businessContinuityService) {
          setService(businessContinuityService);
        } else {
          setService(null);
        }
      } catch (err) {
