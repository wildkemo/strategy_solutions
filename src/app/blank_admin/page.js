...
const validateSession = async () => {
  const response2 = await fetch("http://localhost/oop_project/php_backend/app/Controllers/route.php", {headers: { 'Content-Type': 'application/json' } ,credentials: 'include'})
